     ...
     return (
       ...
       <Form onSubmit={this.handleSubmit} onChange={this.handleChange} style={{ width: '1000px'}}>
        ...
        <Jumbotron>
          ...
          <p className="lead"><h2>Internal Complaint Committee</h2></p>
          <hr className="my-2" />
          <h4>A Committee for addressing Gender Sensitization, Prevention &amp; Prohibition of sexual harassment of women employees and students &amp; redressal of grievances in Technical Institutions.&nbsp;
</h4>
          <p className="lead">
